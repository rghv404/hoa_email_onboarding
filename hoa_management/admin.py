...
class HOAAdmin(admin.ModelAdmin):
    list_display = ['name', 'contact_email', 'phone', 'management_company', 'property_count', 'created_at']
    ...
    fieldsets = (
        ...
        ('Management Details', {
            'fields': ('management_company', 'established_date', 'total_units', 'monthly_fee_range')
        }),
        ('Timestamps', {
...
class PropertyAdmin(admin.ModelAdmin):
    list_display = ['address', 'hoa', 'property_type', 'unit_count', 'monthly_hoa_fee', 'is_active']
    ...
    fieldsets = (
        ...
        ('Property Details', {
            'fields': ('square_footage', 'year_built', 'monthly_hoa_fee', 'is_active')
        }),
        ('Timestamps', {
            'fields': ('created_at', 'updated_at'),
            'classes': ('collapse',)
...
class EmailResponseAdmin(admin.ModelAdmin):
    list_display = ['hoa', 'from_email', 'subject', 'status', 'response_completeness_score', 'created_at']
    ...
    fieldsets = (
        ...
        ('Parsed Responses', {
            'fields': (
                'manages_properties', 'properties_confirmation',
                'regular_dues_amount', 'payment_method', 'payment_address',
                'master_hoa_name', 'phone_number', 'management_company'
            )
        }),
        ('Analysis', {
            'fields': ('response_completeness_score', 'content_preview')
        }),
        ('Review Information', {
