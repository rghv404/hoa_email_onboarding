...
class HOA(models.Model):
    ...
    contact_email = models.EmailField(
        ...
        help_text="Primary contact email for the HOA"
    )
    ...
    established_date = models.DateField(blank=True, null=True, help_text="Date when HOA was established")
    total_units = models.PositiveIntegerField(
        default=0,
        help_text="Total number of units managed by this HOA"
    )
...
class Property(models.Model):
    ...
    is_active = models.BooleanField(
        default=True,
        help_text="Whether this property is actively managed"
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class EmailResponse(models.Model):
    ...
    message_id = models.CharField(
        max_length=255,
        unique=True,
        help_text="Unique message ID from email provider"
    )
    ...
    html_content = models.TextField(
        blank=True,
        null=True,
        help_text="HTML version of email content"
    )
    text_content = models.TextField(
        blank=True,
        null=True,
        help_text="Plain text version of email content"
    )
    ...
    manages_properties = models.BooleanField(
        null=True,
        blank=True,
        help_text="Does HOA manage the listed properties?"
    )
    ...
    regular_dues_amount = models.CharField(
        ...
        blank=True,
        null=True,
        help_text="Amount of regular HOA dues"
    )
    ...
    payment_address = models.TextField(
        blank=True,
        null=True,
        help_text="Mailing address for payments"
    )
    master_hoa_name = models.CharField(
        max_length=200,
        blank=True,
        null=True,
        help_text="Name of master HOA if any"
    )
    ...
    management_company = models.CharField(
        ...
        blank=True,
        null=True,
        help_text="Management company name"
    )

    # Metadata
    response_completeness_score = models.IntegerField(
        default=0,
        help_text="Completeness score from 0-100 based on answered questions"
    )
    ...
    reviewed_at = models.DateTimeField(
        null=True,
        blank=True,
        help_text="When this response was reviewed"
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
